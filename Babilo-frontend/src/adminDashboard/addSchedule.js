...
function AddSchedule(props) {
    ...
    return (
        <div>
            <AdminHeader />
            {
                error == '' ? <p></p>:   <Alert severity="error" sx={{ width: '100%' }}>
                {error}
            </Alert>
            }
                                ...
                                />
                                        ...
                                        >
                                            ...
                                            {movies.map((movie, index) =>
                                                <MenuItem key={index} value={movie.movieId} > {movie.movieName} </MenuItem>
                                            )}
                                    ...
                                    <FormControl variant="standard" sx={{ m: 1, minWidth: 180 }}>
                                        ...
                                        >
                                            ...
                                            {theaters.map((theater, index) =>
                                                <MenuItem key={index} value={theater.theaterId} > {theater.theaterName}- {theater.theaterLocation}</MenuItem>
                                            )}
